...
public object SampleRoutes {
    ...
    public const val FormValidation: String = "form-validation"
...
public val formValidationComponentNames: List<String> = listOf(
    "表单", "表单项",
)
...
public val sampleDestinations: List<SampleDestination> = listOf(
    ...
    SampleDestination(
        route = SampleRoutes.FormValidation,
        group = "组件总览",
        title = "表单与校验",
        components = formValidationComponentNames,
    ),
